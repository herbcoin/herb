...
RESOURCES += src/qt/herb.qrc src/qt/herb_locale.qrc

TRANSLATIONS += src/qt/locale/herb_bg.ts \
                src/qt/locale/herb_de.ts \
                src/qt/locale/herb_en.ts \
                src/qt/locale/herb_es.ts \
                src/qt/locale/herb_fi.ts \
                src/qt/locale/herb_fr.ts \
                src/qt/locale/herb_it.ts \
                src/qt/locale/herb_ja.ts \
                src/qt/locale/herb_pl.ts \
                src/qt/locale/herb_pt.ts \
                src/qt/locale/herb_ru.ts \
                src/qt/locale/herb_sk.ts \
                src/qt/locale/herb_sv.ts \
                src/qt/locale/herb_vi.ts \
                src/qt/locale/herb_zh_CN.ts \
                src/qt/locale/herb_zh_TW.ts
