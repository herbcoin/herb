...
SOURCES += src/activemasternode.cpp \
           ...
           src/Darksend.cpp \
           src/community-cli.cpp \
           src/community-tx.cpp \
           src/community.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/community.qrc src/qt/community_locale.qrc

TRANSLATIONS += src/qt/locale/community_bg.ts \
                src/qt/locale/community_de.ts \
                src/qt/locale/community_en.ts \
                src/qt/locale/community_es.ts \
                src/qt/locale/community_fi.ts \
                src/qt/locale/community_fr.ts \
                src/qt/locale/community_it.ts \
                src/qt/locale/community_ja.ts \
                src/qt/locale/community_pl.ts \
                src/qt/locale/community_pt.ts \
                src/qt/locale/community_ru.ts \
                src/qt/locale/community_sk.ts \
                src/qt/locale/community_sv.ts \
                src/qt/locale/community_vi.ts \
                src/qt/locale/community_zh_CN.ts \
                src/qt/locale/community_zh_TW.ts
