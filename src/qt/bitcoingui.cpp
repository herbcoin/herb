                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HERB-Coin") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HERB address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and herb: URIs)"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HERB Core"), this);
    aboutAction->setStatusTip(tr("Show information about HERB Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HERB"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HERB addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HERB addresses"));
    ...
    openAction->setStatusTip(tr("Open a HERB: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HERB Core help message to get a list with possible HERB command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("HERB Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HERB network", "", count));
}
...
{
    QString strTitle = tr("HERB Core"); // default title
