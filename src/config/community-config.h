/* src/config/community-config.h.  Generated from community-config.h.in by configure.  */
/* src/config/community-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef COMMUNITY_CONFIG_H

#define COMMUNITY_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://bit.communitys"

/* Define to the full name of this package. */
#define PACKAGE_NAME "COMMUNITY Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "COMMUNITY Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "community"
