/* src/config/herb-config.h.  Generated from herb-config.h.in by configure.  */
/* src/config/herb-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef HERB_CONFIG_H

#define HERB_CONFIG_H
...
#define PACKAGE_BUGREPORT "http://bit.herbs"

/* Define to the full name of this package. */
#define PACKAGE_NAME "HERB Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "HERB Core 3.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "herb"
