...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HERB features */
        {"herb", "masternode", &masternode, true, true, false},
        {"herb", "masternodelist", &masternodelist, true, true, false},
        {"herb", "mnbudget", &mnbudget, true, true, false},
        {"herb", "mnbudgetvoteraw", &mnbudgetvoteraw, true, true, false},
        {"herb", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"herb", "mnsync", &mnsync, true, true, false},
        {"herb", "spork", &spork, true, true, false},
#ifdef ENABLE_WALLET
        {"herb", "Darksend", &Darksend, false, false, true}, /* not threadSafe because of SendMoney */
...
void StartRPCThreads()
{
    ...
    if (((mapArgs["-rpcpassword"] == "") ||
        ...
        uiInterface.ThreadSafeMessageBox(strprintf(
                                             _("To use herbd, or the -server option to herb-qt, you must set an rpcpassword in the configuration file:\n"
                                               "%s\n"
...
{
    return "> herb-cli " + methodname + " " + args + "\n";
}
