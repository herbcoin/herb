...
In order to support loading of multiple wallets in herb-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is herb.cpp.
...
Changes to herb.cpp
----------------------
herb.cpp is the entry point into herb-qt, and as such, will require some minor modifications to provide hooks for
